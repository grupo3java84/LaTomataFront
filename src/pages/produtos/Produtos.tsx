  ...
  return (
    <div className="container mx-auto my-12 px-4 font-mono text-[#4a3b32]">
      <div className="flex flex-col items-center text-center mb-10">
        <h1 className="text-3xl md:text-4xl font-black text-[#2b5c40] tracking-tight uppercase">Gestão de Cardápio</h1>
        <p className="text-xs font-bold text-[#4a3b32]/70 uppercase tracking-widest mt-2">Adicione, edite ou remova produtos do cardápio</p>
