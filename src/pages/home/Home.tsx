...
export default function Home(): React.JSX.Element {
  return (
    <div className="bg-yellow-100 text-dark min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 w-full relative z-10">
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
            <div className="inline-flex items-center gap-2 bg-nature/10 text-nature font-black px-4 py-1.5 rounded-full text-xs tracking-wider uppercase">
              <span>🍅</span> Variedade & Sabor Comercial
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 pt-4">
              <button className="button-primary text-base px-8 py-4 rounded-xl cursor-pointer">
                Ver Cardápio
              </button>
              <button className="border-2 border-nature text-nature font-bold text-base px-8 py-4 rounded-xl hover:bg-nature hover:text-cream transition-all cursor-pointer bg-yellow-400 backdrop-blur-sm shadow-sm">
                Conhecer Combos
              </button>
            </div>
          </div>
